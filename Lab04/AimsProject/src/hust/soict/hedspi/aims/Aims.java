...
public class Aims {
    ...
    public static void seeAMediaDetails() {
        ...
        while (!inputCart.equals("0")) {
            switch (inputCart) {
                ...
                case "2":
                    ...
                    ArrayList<Media> mediaInCart = cart.getItemsOrdered();
                    if (sortType.equals("1")) {
                        Collections.sort(mediaInCart, Media.COMPARE_BY_TITLE_COST);
                    } else if (sortType.equals("2")) {
                        Collections.sort(mediaInCart, Media.COMPARE_BY_COST_TITLE);
                    }
                    cart.displayCart();
                    break;
                case "3":
