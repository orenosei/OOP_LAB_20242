...
public class TestPolymorphism {
    public static void main(String[] args) {
        ...
        CompactDisc kimiNoNaWaCD = new CompactDisc(1, "Kimi no Na wa OST", "Music", "RADWIMPS", 0, 12.99f, "RADWIMPS");
        kimiNoNaWaCD.addTrack(new Track("Zenzenzense", 4));
        kimiNoNaWaCD.addTrack(new Track("Sparkle", 6));
        mediaList.add(kimiNoNaWaCD);

        CompactDisc attackOnTitanCD = new CompactDisc(2, "Attack on Titan OST", "Music", "Hiroyuki Sawano", 0, 14.99f, "Hiroyuki Sawano");
